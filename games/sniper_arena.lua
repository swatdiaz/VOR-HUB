...
return function(context)
    ...
    CombatStatusSection:AddToggle({Name = "Expand Enemy + Bot Heads", Description = "Experimental and session-only. Always starts OFF and is never restored by a saved profile.", Flag = "sniper_arena_hitbox_experimental_v2", Persist = false, Default = false, Callback = function(v) state.HitboxExpand = v == true if not state.HitboxExpand then restoreHitboxes() end end})
