...
return function(context)
    ...
    AimSection:AddDropdown({Name = "Target Part", Flag = "sniper_arena_target_part_v2", Persist = false, Options = {"Head", "Torso", "Root"}, Default = "Head", Callback = function(v) state.AimPart = v or "Head" end})
