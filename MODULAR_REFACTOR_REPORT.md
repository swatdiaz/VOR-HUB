...
| Sniper Arena adapter | `games/sniper_arena.lua` | Native shot-path silent aim, cursor aimbot, triggerbot, adjustable enemy-head hitboxes, optional minimal enemy ESP, server-checked kill unlocks, owned loadouts, ready reward claims, matchmaking, and live progression telemetry. |
