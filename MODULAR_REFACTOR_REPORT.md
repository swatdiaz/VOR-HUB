...
| Sniper Arena adapter | `games/sniper_arena.lua` | Native shot-path silent aim, cursor aimbot, auto-fire trigger assist, adjustable enemy-head hitboxes, recoil/spread/reload controls, optional minimal enemy ESP, server-checked kill unlocks, owned loadouts, ready reward claims, matchmaking, and live progression telemetry. |
